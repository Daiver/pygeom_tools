...
def compute_vertices_normals_from_triangles(vertices: np.ndarray, triangle_vertex_indices: np.ndarray) -> np.ndarray:
    """
    Assumes anti-clockwise vertices order
    ...
    normals_per_triangle = compute_normals_for_triangles(vertices, triangle_vertex_indices)
